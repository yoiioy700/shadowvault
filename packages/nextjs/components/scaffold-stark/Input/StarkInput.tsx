...
import { CommonInputProps, InputBase, SIGNED_NUMBER_REGEX } from "~~/components/scaffold-stark";
...
export const StarkInput = ({
    ...
    const [internalUsdMode, setInternalUSDMode] = useState(currencyPrice > 0 ? Boolean(usdMode) : false);
