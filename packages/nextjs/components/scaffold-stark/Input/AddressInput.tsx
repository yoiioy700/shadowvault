...
const AddressAvatar = ({ address }: { address: string }) => {
    ...
    if (isLoading) {
        return <div className="w-[35px] h-[35px] rounded-full bg-gray-200 dark:bg-gray-700 animate-pulse" />;
    }

    return <Image alt="" className="!rounded-full" src={avatarSrc} width="35" height="35" />;
};
