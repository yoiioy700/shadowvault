...
import { Address, AddressInput, Balance, StarkInput } from "~~/components/scaffold-stark";
import { useNetwork, useProvider } from "@starknet-react/core";
import { mintStrk } from "~~/services/web3/faucet";
import { notification } from "~~/utils/scaffold-stark";

const GenericModal = dynamic(() => import("./CustomConnectButton/GenericModal"), { ssr: false });

/**
 * Faucet modal which lets you send STRK to any address.
 */
export const Faucet = () => {
    const faucetAddress: AddressType = "0x78662e7352d062084b0010068b99288486c2d8b914f6e2a55ce945f8792c8b1";
