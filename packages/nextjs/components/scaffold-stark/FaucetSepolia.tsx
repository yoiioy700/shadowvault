            ...
            <GenericModal modalId="faucet-modal">
                <>
                    ...
                    <p className="text-xs mb-6">
                        ...
                        <br /> Please note that these external websites are provided for your convenience. We do not
                        have control over the content and availability of these sites. Use at your own risk.
                    </p>
                    <div className="mb-4">
