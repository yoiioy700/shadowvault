...
import { useFetchAddressDetails, useFetchAllTxns, useFetchEvents } from "~~/hooks/blockexplorer";
...
export default function AddressDetails({ params }: AddressDetailsProps) {
    ...
    const { data: profileData, isLoading: isProfileLoading } = useScaffoldStarkProfile(
        resolvedParams.address as `0x${string}`,
    );
    const { formatted: strkBalance, isLoading: isBalanceLoading } = useScaffoldStrkBalance({
        address: resolvedParams.address as `0x${string}`,
    });

    const { txns: transactionsData, isLoading: isTransactionsLoading } = useFetchAllTxns({
        page: 1,
        pageSize: 10,
    ...
    const addressData = {
        ...
        deployedByContractAddress: addressDetails.deployedByContractAddress || "Not available",
        deployedAtTransactionHash: addressDetails.deployedAtTransactionHash || "Not available",
            ...
            <div className="flex flex-col min-h-screen bg-base-200">
                <div className="bg-primary py-8 px-6 lg:px-10">
                    <div className="max-w-7xl mx-auto">
                        ...
                        <h1 className="text-4xl font-bold text-primary-content">Address Details</h1>
                    </div>
                </div>
                    ...
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-base-100 rounded-lg shadow-lg border border-base-300 p-6">
                            <div className="text-center">
                                ...
                                <h3 className="text-xl font-semibold text-error mb-2">Error Loading Address Details</h3>
                ...
                return (
                    <div className="space-y-6">
                        ...
                        {(profileData?.name || isProfileLoading) && (
                            <div className="flex items-center justify-between py-4 border-b border-base-300">
                                <div className="flex items-center">
                                    ...
                                    <span className="font-medium text-base-content">Starknet Profile</span>
                                </div>
                                <div className="flex items-center">
                                    {isProfileLoading ? (
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <span className="text-blue-400 font-medium">{profileData.name}</span>
                                        </div>
                                    ) : (
                                        <span className="text-base-content/70">No profile found</span>
                                    )}
                                </div>
                            </div>
                        )}
                        ...
                        <div className="flex items-center justify-between py-4 border-b border-base-300">
                            <div className="flex items-center">
                                <span className="text-base-content/70 mr-2">📋</span>
                                <span className="font-medium text-base-content">Contract Address</span>
                            </div>
                            <div className="flex items-center">
                                <code className="text-blue-400 font-mono text-sm">{addressData.contractAddress}</code>
                                <CopyButton text={addressData.contractAddress} fieldName="contract-address" />
                            </div>
                        </div>
                        ...
                        <div className="flex items-center justify-between py-4 border-b border-base-300">
                            <div className="flex items-center">
                                <span className="text-base-content/70 mr-2">🔗</span>
                                <span className="font-medium text-base-content">Class Hash</span>
                            </div>
                            <div className="flex items-center">
                                {isAddressLoading ? (
                                    <span className="loading loading-spinner loading-sm"></span>
                                    ...
                                    <>
                                        <code className="text-blue-400 font-mono text-sm">{addressData.classHash}</code>
                                        {addressData.classHash !== "Not available" && (
                                            <CopyButton text={addressData.classHash} fieldName="class-hash" />
                                        )}
                                    </>
                                )}
                            </div>
                        ...
                        <div className="flex items-center justify-between py-4 border-b border-base-300">
                            <div className="flex items-center">
                                <span className="text-base-content/70 mr-2">💰</span>
                                <span className="font-medium text-base-content">STRK Balance</span>
                            </div>
                            <div className="flex items-center">
                                {isBalanceLoading ? (
                                    <span className="loading loading-spinner loading-sm"></span>
                        ...
                        <div className="flex items-center justify-between py-4 border-b border-base-300">
                            <div className="flex items-center">
                                <span className="text-base-content/70 mr-2">🏗️</span>
                                <span className="font-medium text-base-content">Deployed By Contract Address</span>
                            </div>
                            <div className="flex items-center">
                                <code className="text-blue-400 font-mono text-sm">
                                    {addressData.deployedByContractAddress}
                                </code>
                                <CopyButton text={addressData.deployedByContractAddress} fieldName="deployed-by" />
                            </div>
                        </div>
                        ...
                        <div className="flex items-center justify-between py-4 border-b border-base-300">
                            <div className="flex items-center">
                                <span className="text-base-content/70 mr-2">📦</span>
                                <span className="font-medium text-base-content">Deployed At Transaction Hash</span>
                            </div>
                            <div className="flex items-center">
                                {isAddressLoading ? (
                                    <span className="loading loading-spinner loading-sm"></span>
                                    ...
                                    <>
                                        ...
                                        {addressData.deployedAtTransactionHash !== "Not available" && (
                                            <CopyButton
                        ...
                        <div className="flex items-center justify-between py-4 border-b border-base-300">
                            <div className="flex items-center">
                                <span className="text-base-content/70 mr-2">📅</span>
                                <span className="font-medium text-base-content">Deployed At</span>
                            </div>
                            <div className="flex items-center">
                                {isAddressLoading ? (
                                    <span className="loading loading-spinner loading-sm"></span>
                                ) : (
                                    <span className="text-base-content">{addressData.deployedAt}</span>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="flex items-center justify-between py-4">
                            <div className="flex items-center">
                                <span className="text-base-content/70 mr-2">🔧</span>
                                <span className="font-medium text-base-content">Class Version</span>
                            </div>
                            <div className="flex items-center">
                                {isAddressLoading ? (
                                    <span className="loading loading-spinner loading-sm"></span>
                    ...
                    return (
                        <div className="py-8 text-center">
                            <div className="flex items-center justify-center space-x-2">
                                ...
                                <span className="text-base-content/70">Loading transactions...</span>
                            </div>
                        </div>
                    );
                }
                ...
                if (!transactionsData || transactionsData.length === 0) {
                    return (
                        <div className="py-8 text-center">
                            ...
                            <p className="text-base-content/70">This address has no transaction history yet.</p>
                        </div>
                    );
                }
                    ...
                    <div className="space-y-6">
                            ...
                            <table className="table w-full">
                                <thead>
                                    <tr className="border-b border-base-300">
                                        <th className="text-left text-base-content/70 font-medium">Tx Hash</th>
                                        <th className="text-left text-base-content/70 font-medium">Block</th>
                                        <th className="text-left text-base-content/70 font-medium">Age</th>
                                        <th className="text-left text-base-content/70 font-medium">From</th>
                                        <th className="text-left text-base-content/70 font-medium">Method</th>
                                    </tr>
                                </thead>
                                <tbody>
                                                ...
                                                <td className="py-4">
                                                    {txn.txCalls && txn.txCalls.length > 0 ? (
                                                        <div className="space-y-1">
                                                            {txn.txCalls.slice(0, 2).map((call, callIndex) => (
                                                                <div key={callIndex}>
                        ...
                        {transactionsData.length === 0 && (
                            <div className="text-center py-8">
                                <p className="text-base-content/70">No more transactions to display</p>
                            </div>
                        )}
                    </div>
                );
            ...
            case "events":
                ...
                if (!eventsData || eventsData.length === 0) {
                    return (
                        <div className="py-8 text-center">
                            <div className="text-6xl mb-4">⚡</div>
                            <h3 className="text-xl font-semibold text-base-content mb-2">No Events Found</h3>
                            <p className="text-base-content/70">This address has no contract events yet.</p>
                        </div>
                    );
                }
                ...
                return (
                    <div className="space-y-6">
                        <div className="flex items-center justify-between">
                            <h3 className="text-lg font-semibold text-base-content">Events ({eventsData.length})</h3>
                            <div className="flex items-center space-x-2">
                            ...
                            <table className="table w-full">
                                <thead>
                                    <tr className="border-b border-base-300 bg-base-100">
                                        <th className="text-left text-base-content/70 font-medium py-3 px-4">Name</th>
                                                    ...
                                                    <td className="py-3 px-4">
                                                        <div className="flex items-center space-x-2">
                                                            <button
                                                                ...
                                                                className="text-blue-400 font-mono text-sm hover:text-blue-300 hover:underline transition-colors"
                                                            >
                                                                {event.contractAddress === resolvedParams.address
                                                                    ? "Self Contract"
                        ...
                        {eventsData.length === 0 && (
                            <div className="text-center py-8">
                                <p className="text-base-content/70">No more events to display</p>
                            </div>
                        )}
                    </div>
                );
