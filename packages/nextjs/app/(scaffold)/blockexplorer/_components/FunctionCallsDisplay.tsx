...
export const FunctionCallsDisplay: React.FC<FunctionCallsDisplayProps> = ({
    ...
    <div className="flex flex-col space-y-2">
        <label className="text-lg font-semibold text-base-content">Function Calls:</label>
        <div className="space-y-4">
            {functionCalls.map((call, index) => (
                <div key={index} className="bg-base-200 p-4 rounded-lg">
                    <div className="space-y-2">
                        <div>
                            <span className="text-sm font-semibold text-base-content/70">Contract:</span>
                            <div className="flex items-center mt-1">
                                <Address address={call.contractAddress as `0x${string}`} format="long" size="sm" />
                                <CopyButton
                        ...
                        <div>
                            <span className="text-sm font-semibold text-base-content/70">Entrypoint:</span>
                        ...
                        {call.selector && (
                            <div>
                                <span className="text-sm font-semibold text-base-content/70">Selector:</span>
                                <div className="flex items-center mt-1">
                        ...
                        {(call.calldata.length > 0 ||
                            ...
                            <div>
                                <div className="flex items-center justify-between mb-2">
                                    <span className="text-sm font-semibold text-base-content/70">Arguments:</span>
