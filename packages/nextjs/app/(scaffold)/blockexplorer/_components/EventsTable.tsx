                ...
                <thead>
                    <tr className="border-b border-base-300 bg-base-100">
                        ...
                        {showTransactionColumn && (
                            <th className="text-left text-base-content/70 font-medium py-3 px-4">Transaction Hash</th>
                        )}
                        <th className="text-left text-base-content/70 font-medium py-3 px-4">From Address</th>
                        <th className="text-left text-base-content/70 font-medium py-3 px-4">
                            <div className="flex items-center space-x-1">
                                <span>Age</span>
                                <ChevronDownIcon className="h-4 w-4" />
                                    ...
                                    <td className="py-3 px-4">
                                        <div className="flex items-center space-x-2">
                                            ...
                                            >
                                                ...
                                                <span className="font-medium">{event.eventName || "Event"}</span>
                                            </button>
                                        </div>
                                    </td>
                                    <td className="py-3 px-4">
                                        <span className="text-blue-400 font-medium">{event.blockNumber}</span>
                                    </td>
                                    {showTransactionColumn && (
                                        <td className="py-3 px-4">
                                            <div className="flex items-center space-x-2">
                                        ...
                                        <td colSpan={showTransactionColumn ? 5 : 4} className="py-4 px-4">
                                            <div className="bg-base-100 rounded-lg p-4 border border-base-300">
                                                <div className="flex items-center justify-between mb-3">
                                                    <h4 className="font-semibold text-base-content">Event Arguments</h4>
                                                    <div className="flex items-center space-x-2">
                                                ...
                                                {showRawEventData ? (
                                                    ...
                                                    <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                                                        <p className="text-amber-800 text-sm mb-2">
                                                            <strong>Raw event data (ABI decoding unavailable):</strong>
                                                        </p>
