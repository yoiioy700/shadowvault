...
export default function TransactionDetails({ params }: TransactionDetailsProps) {
    ...
    const { transactionDetail, isLoading, error } = useFetchTxnDetail(resolvedParams.hash);
        ...
        <div className="flex flex-col min-h-screen bg-base-200">
            ...
            <div className="bg-primary py-8 px-6 lg:px-10">
                <div className="max-w-7xl mx-auto">
                    ...
                    <h1 className="text-4xl font-bold text-primary-content">Transaction Details</h1>
                </div>
            </div>
                    ...
                    {isLoading && (
                        <div className="bg-base-100 rounded-lg shadow-lg border border-base-300 p-8">
                            <div className="flex items-center justify-center py-12">
                                ...
                                <span className="ml-4 text-lg">Loading transaction details...</span>
                            </div>
                        </div>
                    )}
                    ...
                    {error && (
                        <div className="bg-base-100 rounded-lg shadow-lg border border-base-300 p-8">
                            <div className="flex flex-col items-center justify-center py-12">
                                ...
                                <h2 className="text-2xl font-bold text-error mb-2">Error Loading Transaction</h2>
                    ...
                    {!isLoading && !error && !transactionDetail && (
                        <div className="bg-base-100 rounded-lg shadow-lg border border-base-300 p-8">
                            <div className="flex flex-col items-center justify-center py-12">
                                ...
                                <h2 className="text-2xl font-bold text-warning mb-2">Transaction Not Found</h2>
                                <p className="text-base-content/70 text-center max-w-md">
                                    The transaction with hash{" "}
                                    <code className="bg-base-200 px-2 py-1 rounded">{resolvedParams.hash}</code> could
                                    not be found.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="bg-base-100 rounded-lg shadow-lg border border-base-300 p-8">
                            <div className="space-y-8">
                                ...
                                <div className="flex flex-col space-y-2">
                                    <label className="text-lg font-semibold text-base-content">Transaction Hash:</label>
                                    <div className="flex items-center">
                                        <code className="text-base font-mono text-accent bg-base-200 px-3 py-2 rounded">
                                            {transactionDetail.transactionHash}
                                        </code>
                                        <CopyButton text={transactionDetail.transactionHash} fieldName="hash" />
                                    </div>
                                </div>

                                {/* Transaction Type */}
                                <div className="flex flex-col space-y-2">
                                    <label className="text-lg font-semibold text-base-content">Transaction Type:</label>
                                ...
                                {/* Status */}
                                <div className="flex flex-col space-y-2">
                                    <label className="text-lg font-semibold text-base-content">Status:</label>
                                    <span
                                ...
                                {transactionDetail.blockNumber && (
                                    <div className="flex flex-col space-y-2">
                                        <label className="text-lg font-semibold text-base-content">Block Number:</label>
                                ...
                                {transactionDetail.timestamp && (
                                    <div className="flex flex-col space-y-2">
                                        <label className="text-lg font-semibold text-base-content">Timestamp:</label>
                                        <span className="text-base text-base-content">
                                ...
                                {transactionDetail.senderAddress && (
                                    <div className="flex flex-col space-y-2">
                                        ...
                                        <div className="flex items-center">
                                            <Address
                                                address={transactionDetail.senderAddress as `0x${string}`}
                                                format="long"
                                                size="base"
                                            />
                                            <CopyButton text={transactionDetail.senderAddress} fieldName="sender" />
                                        </div>
                                    </div>
                                )}
                                ...
                                {transactionDetail.contractAddress && (
                                    <div className="flex flex-col space-y-2">
                                        ...
                                        <div className="flex items-center">
                                            <Address
                                                address={transactionDetail.contractAddress as `0x${string}`}
                                                format="long"
                                                size="base"
                                            />
                                            <CopyButton text={transactionDetail.contractAddress} fieldName="contract" />
                                        </div>
                                    </div>
                                )}
                                ...
                                {transactionDetail.nonce && (
                                    <div className="flex flex-col space-y-2">
                                        <label className="text-lg font-semibold text-base-content">Nonce:</label>
                                        <span className="text-base text-base-content">{transactionDetail.nonce}</span>
                                    </div>
                                )}

                                {/* Function Calls (for INVOKE transactions) */}
                                {transactionDetail.functionCalls && transactionDetail.functionCalls.length > 0 && (
                                    <div className="flex flex-col space-y-2">
                                        <label className="text-lg font-semibold text-base-content">
                                            Function Calls:
                                        </label>
                                ...
                                {transactionDetail.maxFee && (
                                    <div className="flex flex-col space-y-2">
                                        <label className="text-lg font-semibold text-base-content">Max Fee:</label>
                                        <span className="text-base text-base-content">
                                ...
                                {transactionDetail.actualFee && (
                                    <div className="flex flex-col space-y-2">
                                        <label className="text-lg font-semibold text-base-content">Actual Fee:</label>
                                        <span className="text-base text-base-content">
                                ...
                                {/* Signature */}
                                {transactionDetail.signature && transactionDetail.signature.length > 0 && (
                                    <div className="flex flex-col space-y-2">
                                        <label className="text-lg font-semibold text-base-content">Signature:</label>
                                        <div className="relative">
                                            ...
                                            <CopyButton
                                                text={JSON.stringify(transactionDetail.signature, null, 2)}
                                                fieldName="signature"
                                            />
                                        </div>
                                    </div>
                                        ...
                                        {isEventsLoading ? (
                                            <div className="bg-base-200 rounded-lg p-8">
                                                <div className="flex items-center justify-center">
                                                    <div className="loading loading-spinner loading-lg"></div>
                                                    <span className="ml-4 text-base-content/70">Loading events...</span>
                                                </div>
                                            </div>
                                    ...
                                    <div className="flex flex-col space-y-2">
                                        ...
                                        <div className="bg-base-200 p-4 rounded-lg">
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                ...
                                                {transactionDetail.executionResources.builtin_instance_counter && (
                                ...
                                {transactionDetail.version && (
                                    <div className="flex flex-col space-y-2">
                                        <label className="text-lg font-semibold text-base-content">Version:</label>
                                        <span className="text-base text-base-content font-mono bg-base-200 px-3 py-1 rounded w-fit">
                                            {transactionDetail.version}
                                        </span>
                                    </div>
                                ...
                                {transactionDetail.revertReason && (
                                    <div className="flex flex-col space-y-2">
                                        <label className="text-lg font-semibold text-error">Revert Reason:</label>
