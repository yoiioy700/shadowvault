...
import { TransactionTable, LoadingState, Pagination, EmptyState } from "./_components";
...
export default function BlockExplorer() {
    ...
    const currentTransactions = useMemo(() => {
        return txns.map((tx): TxnEntry => {
            const isDeploy = tx.txCalls.some((call) => (call.functionCalled || "") === "Deploy Contract");
            ...
            return {
                ...
                from: tx.fromAddress || "",
                status: (tx.txReceipt as any)?.execution_status || (tx.txReceipt as any)?.finality_status || "UNKNOWN",
        ...
        <div className="flex flex-col min-h-screen bg-base-200">
            ...
            <div className="bg-primary py-12 px-6 lg:px-10">
                <div className="max-w-7xl mx-auto">
                    <h1 className="text-4xl font-bold text-primary-content mb-8">Block Explorer</h1>
            ...
            <div className="flex-1 px-6 lg:px-10 py-8">
                <div className="max-w-7xl mx-auto">
                    {/* Loading State */}
                    {isLoading && <LoadingState message="Loading Transactions" currentPage={currentPage} />}
