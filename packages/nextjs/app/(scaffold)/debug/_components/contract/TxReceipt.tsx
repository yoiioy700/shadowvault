...
import { decodeContractResponse } from "~~/app/(scaffold)/debug/_components/contract";

export const TxReceipt = (
    txResult: string | number | bigint | Record<string, any> | InvokeTransactionReceiptResponse | undefined,
) => {
