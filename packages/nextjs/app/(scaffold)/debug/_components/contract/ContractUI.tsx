...
import { useDeployedContractInfo, useNetworkColor } from "~~/hooks/scaffold-stark";
...
const ContractReadMethods = dynamic(() => import("./ContractReadMethods").then((mod) => mod.ContractReadMethods));
