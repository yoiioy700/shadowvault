...
export default function DownloadContracts() {
    ...
    const handleDownload = useCallback(async () => {
        ...
        try {
            ...
            const mergedPredeployedContracts = deepMergeContracts(contractData, configExternalContracts);
    ...
    */`;
        ...
        const [prettier, parserTypescript, prettierPluginEstree] = await Promise.all([
    ...
    return (
        <div className="flex flex-col gap-y-6 lg:gap-y-8 py-8 lg:py-12 justify-center items-center">
            <div className="p-6 px-8 mx-2 border-gradient rounded-[5px] w-full max-w-6xl contract-content">
                <div className="text-xl mb-2 font-bold">Fetch Contract Configuration File from Contract Address</div>
                <div className="flex flex-col gap-12 sm:gap-24 sm:flex-row">
                    <div className="flex-1">
                        <div className="font-bold my-3 text-lg">Instructions</div>
                        <p className="my-2">
                            This tool generate a contract configuration file by entering a contract address and name.
                            The downloaded file can be used to replace your local{" "}
                            <code className="text-function">configExternalContracts.ts</code> for debugging.
                        </p>
                        <ol className="flex flex-col gap-2 list-decimal list-outside my-6 space-y-1 ml-4">
                            ...
                            <li className="pl-3">
                                Click <strong className="text-function">Download Contract File</strong>
                            </li>
                            <li className="pl-3">
                                Replace your <code className="text-function">configExternalContracts.ts</code> file
                            </li>
                            <li className="pl-3">
                    ...
                    <div className="flex-1 px-12">
                        {targetNetwork && (
                            <div className="my-4 flex text-md flex-col">
                                <div className="w-24 mb-2 font-medium break-words text-function">Network</div>
                                <span>{targetNetwork.name}</span>
                            </div>
                        )}
                        <div className="flex flex-col my-6">
                            <div className="w-24 mb-2 font-medium break-words text-function">Contract</div>
                            <input
                                value={contractName}
                        ...
                        <div className="flex flex-col text-accent my-6">
                            <div className="w-24 mb-2 font-medium break-words text-function">Address</div>
                            ...
                            >
                                ...
                                <span>
                                    <ArrowDownTrayIcon className="h-4 w-4 cursor-pointer" aria-hidden="true" />
                                </span>
                            </button>
                        </div>
                    </div>
