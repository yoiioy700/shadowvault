...
import { AccountInterface, InvokeFunctionResponse, constants, Call, ETransactionVersion } from "starknet";
...
export const useTransactor = (_walletClient?: AccountInterface): UseTransactorReturn => {
    ...
    const writeTransaction = async (tx: Call[], withSendTransaction: boolean = true): Promise<string | undefined> => {
        resetStates();
        if (!walletClient) {
