...
describe("useFetchTxnDetail", () => {
    ...
    it("should fetch INVOKE transaction details", async () => {
        ...
        const mockTxInstance = {
            ...
            calldata: ["0x1", "0xcontract123", "0xselector456", "0x2", "0xarg1", "0xarg2"],
        ...
        expect(result.current.transactionDetail?.logs).toEqual(["0xcontract123", "0xkey1", "0xdata1"]);
    });
    ...
    it.skip("should handle complete fetch errors", async () => {
        ...
        mockRpcProvider.getTransactionReceipt.mockRejectedValue(new Error("Receipt not found"));
