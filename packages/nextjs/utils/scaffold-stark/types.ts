...
export const isCairoBytes31 = (type: string): type is CairoBytes31 => type.includes("core::bytes_31::bytes31");

export const isCairoByteArray = (type: string): type is CairoByteArray => type.includes("core::byte_array::ByteArray");
