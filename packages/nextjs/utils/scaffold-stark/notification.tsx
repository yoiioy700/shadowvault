...
const Notification = ({
    ...
    return toast.custom(
        (t: Toast) => (
            <ToastContent t={t} content={content} status={status} icon={icon} position={position} duration={duration} />
        ),
        {
...
export const notification = {
    ...
    error: (content: React.ReactNode, options?: NotificationOptions) => {
        ...
        const fallbackContent: React.ReactNode = (
            <div>
                <div className="font-semibold text-red-500 text-base">❌ Transaction failed</div>
