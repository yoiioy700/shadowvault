...
const args = {
    ...
    arr: [1n, 2n],
    greeting_setter: 2846891009026995430665703316224827616914889274105712248413538305735679628945n,
...
describe("parseEventData", () => {
    it("should parse event data correctly", () => {
        expect(parseEventData(args, types)).toEqual({
            ...
            arr: [1n, 2n],
            greeting_setter: "0x064b48806902a367c8598f4F95C305e8c1a1aCbA5f082D294a43793113115691",
            greeting: "hello world",
            premium: true,
            tup: {
                0: 1n,
