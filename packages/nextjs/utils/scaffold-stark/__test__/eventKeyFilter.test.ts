...
import { CairoCustomEnum, CairoOption, CairoOptionVariant, CallData } from "starknet";
...
const event = mockDeployedContractAbi.abi.find(
    (part) => part.type === "event" && part.name === "contracts::your_contract::YourContract::GreetingChanged",
);
...
describe("serializeEventKey", () => {
    ...
    it("should serialize event long string event key correctly", () => {
        ...
        ).toEqual(["0x1", "0x4c6f6e6720737472696e672c206d6f7265207468616e203331206368617261", "0x63746572732e", "0x6"]);
    });
    ...
    it("should serialize ContractAddress event key correctly", () => {
        ...
        ).toEqual(["0x64b48806902a367c8598f4f95c305e8c1a1acba5f082d294a43793113115691"]);
    });
    ...
    it("should serialize tuple event key correctly", () => {
        ...
        ).toEqual(["0x1", "0x2", "0x1", "0x64b48806902a367c8598f4f95c305e8c1a1acba5f082d294a43793113115691"]);
    });
    ...
    it("should serialize struct event key correctly", () => {
        ...
        ).toEqual(["0x0", "0x64b48806902a367c8598f4f95c305e8c1a1acba5f082d294a43793113115691", "0x1"]);
    });
    ...
    it("should compose event filter keys correctly", () => {
        expect(
            composeEventFilterKeys(
                {
                    greeting_setter: "0x64b48806902a367c8598f4f95c305e8c1a1acba5f082d294a43793113115691",
