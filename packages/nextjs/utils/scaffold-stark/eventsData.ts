...
export const parseEventData = (args: Record<string, any>, types: { name: string; type: string; kind: string }[]) => {
    ...
    Object.keys(args).forEach((paramName: string) => {
        ...
        } else if (paramType === "core::array::Array::<core::starknet::contract_address::ContractAddress>") {
